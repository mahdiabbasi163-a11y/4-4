...
data class KodyarUser(
    ...
    val isTechnicianUser: Boolean
        get() = (role == "technician" || role == "tech" || role == "repairman") && isApprovedUser
...
data class TicketModel(
    ...
    val statusDisplay: String
        get() {
            ...
            return when {
                s.contains("حل") || s.contains("resolved") || s.contains("solved") || s.contains("done") -> "حل شده"
                s.contains("مجدد") || s.contains("reopen") || s.contains("review") || s.contains("بررسی مجدد") -> "بررسی مجدد"
                s.contains("بست") || s.contains("close") -> "بسته شده"
                s.contains("پاسخ") || s.contains("answered") || s.contains("replied") -> "پاسخ داده شده"
                s.contains("بررسی") || s.contains("open") || s.contains("progress") || s.contains("ongoing") || s.contains("در حال") -> "در حال بررسی"
                s.contains("انتظار") || s.contains("pending") || s.contains("waiting") -> "در انتظار پاسخ"
