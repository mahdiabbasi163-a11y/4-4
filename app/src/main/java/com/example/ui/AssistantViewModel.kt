...
class AssistantViewModel(
    ...
    init {
        ...
        // Immediate fast local cache load (Instant startup - zero UI blocking, cached errors & problems available offline)
        loadCachedDatabase()
    ...
    fun getSavedAuthPassword(): String {
        ...
        return sharedPrefs.getString("saved_auth_password", "") ?: ""
    }
